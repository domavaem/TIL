var store = [{
        ...
        "excerpt":"ERROR: While executing gem … (Errno::ENOTEMPTY) Directory not empty @ dir_s_rmdir - /Users/spo/.rbenv/versions/3.0.0/lib/ruby/gems/3.0.0/gems/bundler-2.3.5 incompatible library version - /Users/spo/.gem/ruby/3.0.0/gems/ffi-1.15.5/lib/ffi_c.bundle (LoadError) cannot load such file – 3.0/ffi_c (LoadError) $ gem pristine ffi 이걸로 안되면 $ gem uninstall ffi $ gem install ffi rbenv 설치 후 Check your installation curl -fsSL https://github.com/rbenv/rbenv-installer/raw/main/bin/rbenv-doctor |...","categories": ["memo"],
        "tags": [],
        "url": "/TIL/memo/2022/01/24/install-jekyll-on-mac.html",
        "teaser": null
      },{
        "title": "Memo",
        ...
        "title": "초기 설치",
        "excerpt":"React 일단은 그냥 CRA 사용 npx create-react-app [project name] cd [project name] npm install react-router-dom@6 타입스크립트 기반 CRA npx create-react-app [project name] --template typescript mobx npm install mobx npm install mobx-react npm install mobx-react-lite // 함수형 컴포넌트만 지원 axios npm install axios styled-components npm install styled-components mui emotion 사용이 default...","categories": ["react"],
        "tags": [],
